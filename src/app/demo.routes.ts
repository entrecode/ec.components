    ...
    children: [
      ...
      },
      {
        ...
        data: {
          ...
          links: ['modules/IconModule.html', 'additional-documentation/ui/icons.html'],
        },
      },
      {
        path: 'symbols',
        ...
        data: {
          ...
          links: ['modules/SymbolModule.html'],
        },
      },
      {
        path: 'list-basic',
        ...
        data: {
          ...
          links: ['components/ListComponent.html#readme', 'modules/ListModule.html'],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          paths: [
            'form/form-demo.component.ts',
            'form/form-demo.component.html',
            'form/cool-string.component.ts',
            'form/cool-string.component.html',
            'form/counter.component.ts',
          ],
          links: [
            'modules/FormModule.html',
      ...
      },
      {
        ...
        data: {
          ...
          links: ['modules/SelectModule.html'],
        },
      },
      {
        path: 'datetime',
        ...
        data: {
          ...
          links: [
            'components/CalendarComponent.html',
            'components/DatetimeComponent.html',
            'components/MonthComponent.html',
            'components/HeatmapComponent.html',
          ],
        },
      },
      {
        ...
        data: {
          paths: [
            'pop/pop-demo.component.html',
            'pop/pop-demo.component.ts',
            'pop/pop-trigger.component.ts',
            'pop/pop.markup.html',
          ],
      ...
      },
      {
        ...
        data: {
          paths: [
            'notifications-demo/notifications-demo.component.html',
            'notifications-demo/notifications-demo.component.ts',
          ],
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          ...
          links: [
            'components/ResourceListComponent.html',
            'components/ResourceFormComponent.html',
      ...
      },
      {
        ...
        data: {
          paths: [
            'resource-delete-pop/resource-delete-pop-demo.component.html',
            'resource-delete-pop/resource-delete-pop-demo.component.ts',
          ],
      ...
      },
      {
        ...
        data: {
          paths: [
            'resource-select/resource-select-demo.component.html',
            'resource-select/resource-select-demo.component.ts',
          ],
      ...
      },
      {
        ...
        data: {
          paths: [
            'resource-list-pop/resource-list-pop-demo.component.ts',
            'resource-list-pop/resource-list-pop-demo.component.html',
          ],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          paths: [
            'entry-list-select/entry-list-select-demo.component.html',
            'entry-list-select/entry-list-select-demo.component.ts',
          ],
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          ...
          links: [
            'directives/AssetDirective.html#readme',
            'directives/ImageDirective.html#info',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          paths: [
            'password-reset/password-reset-demo.component.html',
            'password-reset/password-reset-demo.component.ts',
          ],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          paths: [
            'medium-editor-demo/medium-editor-demo.component.html',
            'medium-editor-demo/medium-editor-demo.component.ts',
          ],
        },
      },
      {
