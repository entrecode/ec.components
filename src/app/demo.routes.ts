  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          paths: ['resource-delete-pop/resource-delete-pop-demo.component.html',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          paths: ['tinymce-demo/tinymce-demo.component.html', 'tinymce-demo/tinymce-demo.component.ts', 'tinymce-demo/tiny-input.ts']
        }
      },
      {
        path: 'ace',
