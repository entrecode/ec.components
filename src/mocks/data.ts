...
import { CoolStringComponent } from '../app/form/cool-string.component';
import { songs } from '../assets/songs';
import { UnsplashImageComponent } from '../app/list/unsplash-image.component';
      ...
      ],
      {
        ...
        fields: {
          ...
          button: {
            ...
            resolve: () => ' ',
            view: 'link',
            class: 'btn btn_minor btn_square',
            icon: 'eye-open',
