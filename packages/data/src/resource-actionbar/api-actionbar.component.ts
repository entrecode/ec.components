...
import { Action, ActionbarComponent, ActionFunction } from '@ec.components/ui/src/actionbar/actionbar.component';
    ...
    @Input() actions: Action[] = [
        {
            id: 'data',
            title: 'Datamanager',
            action: (item, actionbar) => this.loadResourceListActions({
                api: this.sdk.datamanager, relation: 'dataManager', actionbar,
                action: (dm) => {
